...
function render_block_core_navigation( $attributes, $content, $block ) {
	...
	foreach ( $inner_blocks as $inner_block ) {
		if ( ( 'core/navigation-link' === $inner_block->name || 'core/home-link' === $inner_block->name || 'core/dropdown' === $inner_block->name ) && false === $is_list_open ) {
			$is_list_open       = true;
			$inner_blocks_html .= '<ul class="wp-block-navigation__container">';
		}
		if ( 'core/navigation-link' !== $inner_block->name && 'core/home-link' !== $inner_block->name && 'core/dropdown' !== $inner_block->name && true === $is_list_open ) {
			$is_list_open       = false;
